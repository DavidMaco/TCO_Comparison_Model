# Skills Implementation — TCO Comparison Model
...
Use for non-trivial tasks with architectural choices, cross-file changes,
or uncertain requirements.

### standards-review

Use for compliance and quality audits before merge.
